# ============================================================================
# Robot Project Parameters
# ============================================================================
# This file stores shared settings used by the robot control, logging,
# localization, and filtering scripts.
#
# Main contents:
# - UDP network settings for laptop-to-Arduino communication.
# - Camera calibration values for marker pose estimation.
# - Robot sensor and control signal settings.
# - Data logging file names and saved data fields.
# - Experiment timing values for trial recording.
# - Kalman filter and particle filter settings.
# - Simple wall-map coordinates used by the particle filter.
# ============================================================================
...
# UDP parameters
localIP = "<Enter Laptop IP>" # Put your laptop computer's IP here 199
arduinoIP = "<Enter Arduino IP>" # Put your arduino's IP here 200
localPort = 4010
arduinoPort = 4010
bufferSize = 1024

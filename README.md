...
The final demonstrated run navigated to **Tag 17** in **29.97 s**, with **0 collisions**, a logged final heading error of **0.61°**, and a final logged position error of **1.30 m**. The robot reached the correct physical AprilTag goal; the remaining logged position error mainly reflects odometry/map-frame drift rather than the robot stopping at the wrong target.
